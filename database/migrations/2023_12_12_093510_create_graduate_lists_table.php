...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('graduate_lists', function (Blueprint $table) {
            ...
            $table->text('guest1_present_address')->nullable();
            $table->text('guest1_permanent_address')->nullable();
            ...
            $table->text('guest2_present_address')->nullable();
            $table->text('guest2_permanent_address')->nullable();
